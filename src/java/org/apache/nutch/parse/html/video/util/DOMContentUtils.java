...
public class DOMContentUtils {
	  ...
	  public void setConf(Configuration conf) {
	    ...
	    /*if (conf.getBoolean("parser.html.form.use_action", true)) {
			System.out.println("1144442222222222222222");
	      linkParams.put("form", new LinkParams("form", "action", 1));
	      if (conf.get("parser.html.form.use_action") != null)
		  	System.out.println("1144442222555555555555522222");
	        forceTags.add("form");
	    }*/
	    ...
	    for ( int i = 0 ; ignoreTags != null && i < ignoreTags.length ; i++ ) {
			System.out.println("1144442222222222222222:"+ignoreTags[i]);
	  ...
	  private boolean getTextHelper(StringBuffer sb, Node node, 
	    ...
	    while (walker.hasNext()) {
		  ...
		  //System.out.println("nodevalue:"+currentNode.getNodeValue());
